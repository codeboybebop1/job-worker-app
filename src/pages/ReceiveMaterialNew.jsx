  ...
  return (
    <div>
      ...
      <div className="bg-panel border border-border rounded-lg p-4 mb-4">
        <ReceiveMaterialForm form={form} setForm={setForm} jobWorkers={jobWorkers} itemTypes={itemTypes} parties={parties} fabrics={fabrics} onSave={handleSave} onCancel={handleCancel} />
      </div>
      {form.id && (
